...
l_password = os.getenv("LINKEDIN_PASSWORD")
# Step 2: Log in to LinkedIn
username = driver.find_element(By.ID, "username")
password = driver.find_element(By.ID, "password")
username.send_keys(l_email)  # Replace with your LinkedIn email
password.send_keys(l_password)  # Replace with your LinkedIn password
...
search_box = driver.find_element(By.CSS_SELECTOR,
                                 ".search-global-typeahead__input.search-global-typeahead__input--ellipsis")
